...
export const ProjectsShowcase = () => {
  return (
    <div id="projects-showcase" className="w-full bg-[#ff7a00] py-24 px-6 md:px-12 relative z-10 text-black">
      ...
      <div className="max-w-5xl mx-auto flex flex-col gap-16 md:gap-24 relative z-10">
        ...
        <div className="anim-fade-up max-w-3xl text-center md:text-left mx-auto md:mx-0">
          <h2 className="font-serif text-4xl md:text-5xl mb-6 font-bold" style={{ color: "#000000" }}>Systemic Leverage</h2>
          <p className="text-xl md:text-2xl font-medium leading-relaxed" style={{ color: "#000000" }}>
        ...
        <div className="anim-fade-up flex flex-col md:flex-row gap-12 bg-white rounded-[2rem] p-8 md:p-12 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] sticky top-24 z-10">
          <div className="flex-1 flex flex-col justify-center">
            <h3 className="font-serif text-4xl font-bold mb-4 text-black">Builder's House</h3>
            <div className="mb-6">
            ...
            <h4 className="font-bold text-lg mb-2 text-black/90">The Problem</h4>
            ...
            <h4 className="font-bold text-lg mb-2 text-black/90">The Reality</h4>
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="inline-block bg-[#ff7a00] text-white font-bold uppercase tracking-wider py-4 px-8 rounded-xl hover:bg-black transition-colors w-max shadow-lg"
            >
              See Now
            </a>
          </div>
        ...
        {/* Project 2: LEDGR */}
        <div className="anim-fade-up flex flex-col md:flex-row-reverse gap-12 bg-[#fff8f0] rounded-[2rem] p-8 md:p-12 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] sticky top-32 z-20">
          <div className="flex-1 flex flex-col justify-center">
            <h3 className="font-serif text-4xl font-bold mb-4 text-black">LEDGR</h3>
            <div className="mb-6">
        ...
        <div className="anim-fade-up flex flex-col md:flex-row gap-12 bg-[#f8f9fa] rounded-[2rem] p-8 md:p-12 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] sticky top-40 z-30">
          <div className="flex-1 flex flex-col justify-center">
            <h3 className="font-serif text-4xl font-bold mb-4 text-black">Automate 90</h3>
            <div className="mb-6">
